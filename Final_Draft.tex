...
We now provide concise proofs for the probability that the GCD and $k$-GCD are $B$-smooth by using counting arguments. Appendix A contains detailed versions of Cheon and Kim's original proofs using the inclusion-exclusion principle. %Hyperref? 
...
\section{Appendix}
\subsection{Probability that the GCD of products of positive integers is \texorpdfstring{$B$}{\mathbb{B}}-smooth using Inclusion-Exclusion}
...
\subsection{Probability that the \texorpdfstring{$k$}{\mathbb{k}}-GCD of products of positive integers is \texorpdfstring{$B$}{\mathbb{B}}-smooth with Inclusion-Exclusion}
