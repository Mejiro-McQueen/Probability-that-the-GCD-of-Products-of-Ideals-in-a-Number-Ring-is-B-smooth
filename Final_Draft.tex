...
%\todo[inline, color=yellow]{Double Check: Was erroneously a duplicate of 1-GCD proof.}
%Ok
...
%\todo[inline, color=yellow]{Not $c=1$, should $\epsilon=1$}
%Answer: Yes!
...
\section{Appendix}
\subsection{Probability that the GCD of products of positive integers is \texorpdfstring{$B$}{\mathbb{B}}-Friable using Inclusion-Exclusion}
...
\subsection{Probability that the \texorpdfstring{$k$}{\mathbb{k}}-GCD of products of positive integers is \texorpdfstring{$B$}{\mathbb{B}}-Friable with Inclusion-Exclusion}
...
%%\todo[inline, color=orange]{Use $k\mhyphen\gcd$ instead of $\gcd_k$, make new operator}
% I prefer \gcd_k; it looks nicer!


%\todo[inline, color=orange]{texorpdf on section titles}
%Yes as well!
