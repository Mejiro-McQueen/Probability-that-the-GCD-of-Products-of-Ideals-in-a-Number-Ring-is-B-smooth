...
\todo[inline, color=red]{Introduction Material}

\subsection{Elementary Background}
\todo[inline, color=red]{Elementary Background}
...
\section{Appendix I}
\todo[inline, color=red]{Maybe we can write a program too? Might be able to tie it in with crypto.}
\end{document}